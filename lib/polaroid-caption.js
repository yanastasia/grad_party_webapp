...
const ALLURA_ROOT = path.join(process.cwd(), 'node_modules', '@fontsource', 'allura');
const CORMORANT_ROOT = path.join(process.cwd(), 'node_modules', '@fontsource', 'cormorant-garamond');
